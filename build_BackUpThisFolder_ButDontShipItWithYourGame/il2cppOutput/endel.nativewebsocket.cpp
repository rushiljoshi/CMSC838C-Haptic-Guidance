...
IL_0098_3:
					{
						...
						NullCheck(L_31);
						List_1_tF470A3BE5C1B5B68E1325EF3F109D172E60BD7CD* L_32 = L_31->___subprotocols_6;
						NullCheck(L_32);
...
IL_00df_3:
					{
						...
						NullCheck(L_41);
						ClientWebSocket_tCA318357FEA5850DFE2109A0139A57F152E0D71F* L_42 = L_41->___m_Socket_7;
						WebSocket_tA854BC697D5FA80EB48E9217EF622E0F9B0E325F* L_43 = V_1;
						NullCheck(L_43);
						Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_44 = L_43->___uri_4;
...
IL_012a_3:
					{
						...
						V_6 = L_53;
						TaskAwaiter_t9B661AC8C2EFA6BAB94C77BB24A5DDA82D61F833* L_54 = (&__this->___U3CU3Eu__1_3);
...
IL_0147_3:
					{
						...
						NullCheck(L_56);
						WebSocketOpenEventHandler_t0241D6C4719F6CD56F1FE610A9371AC15FDCC93E* L_57 = L_56->___OnOpen_0;
...
IL_0199_3:
					{
						TaskAwaiter_t9B661AC8C2EFA6BAB94C77BB24A5DDA82D61F833 L_66 = __this->___U3CU3Eu__1_3;
						V_6 = L_66;
						TaskAwaiter_t9B661AC8C2EFA6BAB94C77BB24A5DDA82D61F833* L_67 = (&__this->___U3CU3Eu__1_3);
				...
				{// begin catch(System.Exception)
					{
						...
						NullCheck(L_69);
						WebSocketErrorEventHandler_t6121C1087F8242428F801B27D293CE78597A75C3* L_70 = L_69->___OnError_2;
						WebSocketErrorEventHandler_t6121C1087F8242428F801B27D293CE78597A75C3* L_71 = L_70;
						G_B31_0 = L_71;
						if (L_71)
						{
							G_B32_0 = L_71;
...
IL_01cd_2:
					{
						...
						NullCheck(L_72);
						String_t* L_73;
						L_73 = VirtualFuncInvoker0< String_t* >::Invoke(5 /* System.String System.Exception::get_Message() */, L_72);
						NullCheck(G_B32_0);
						WebSocketErrorEventHandler_Invoke_mB37D569F452D31AF71A4649E67D3FA299F37DB50_inline(G_B32_0, L_73, NULL);
					}

IL_01d9_2:
					{
						// OnClose?.Invoke(WebSocketCloseCode.Abnormal);
						WebSocket_tA854BC697D5FA80EB48E9217EF622E0F9B0E325F* L_74 = V_1;
						NullCheck(L_74);
						WebSocketCloseEventHandler_tC02B2B8CA126489D18F9F48805A3C7460661E466* L_75 = L_74->___OnClose_3;
						WebSocketCloseEventHandler_tC02B2B8CA126489D18F9F48805A3C7460661E466* L_76 = L_75;
						G_B34_0 = L_76;
						if (L_76)
						{
							G_B35_0 = L_76;
...
IL_0131_1:
			...
			{// begin try (depth: 2)
				...
				L_44 = VirtualFuncInvoker4< Task_t751C4CC3ECD055BABA8A0B6A5DFBB4283DCA8572*, ArraySegment_1_t3DC888623B720A071D69279F1FCB95A109195093, int32_t, bool, CancellationToken_t51142D9C6D7C02D314DA34A6A7988C528992FFED >::Invoke(11 /* System.Threading.Tasks.Task System.Net.WebSockets.WebSocket::SendAsync(System.ArraySegment`1<System.Byte>,System.Net.WebSockets.WebSocketMessageType,System.Boolean,System.Threading.CancellationToken) */, L_39, L_40, L_41, (bool)1, L_43);
...
IL_00dd_4:
						{
							...
							L_27 = VirtualFuncInvoker2< Task_1_t7A5D3E6F94872974689076E6A3A64E3104677A40*, ArraySegment_1_t3DC888623B720A071D69279F1FCB95A109195093, CancellationToken_t51142D9C6D7C02D314DA34A6A7988C528992FFED >::Invoke(10 /* System.Threading.Tasks.Task`1<System.Net.WebSockets.WebSocketReceiveResult> System.Net.WebSockets.WebSocket::ReceiveAsync(System.ArraySegment`1<System.Byte>,System.Threading.CancellationToken) */, L_23, L_24, L_26);
							NullCheck(L_27);
...
IL_0145_4:
						{
							...
							NullCheck(L_38);
							VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(33 /* System.Void System.IO.Stream::Write(System.Byte[],System.Int32,System.Int32) */, L_38, L_40, L_42, L_44);
...
IL_01ea_4:
							...
							{// begin try (depth: 5)
								...
								L_60 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(39 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_59);
								NullCheck(L_58);
...
IL_0237_4:
							...
							{// begin try (depth: 5)
								...
								L_72 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(39 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_71);
								NullCheck(L_70);
...
IL_02ed_3:
				{
					...
					NullCheck(L_90);
					int32_t L_91;
					L_91 = VirtualFuncInvoker0< int32_t >::Invoke(5 /* System.Net.WebSockets.WebSocketState System.Net.WebSockets.WebSocket::get_State() */, L_90);
...
IL_03a9_1:
		{
			...
			L_114 = ExceptionDispatchInfo_Capture_mC1C1C30D83DC04B2B7813DFCB67D07CCD4909803(G_B57_0, NULL);
			NullCheck(L_114);
